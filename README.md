...
- **Sample file**: TSV file containing sample information. Must contain the following columns:
  ...
  | AS_1   | SRX1607052_T1.fastq.gz |       | Artificial_Sputum |   2    |   1    |    reverse   |
  | AS_1   | SRX1607053_T1.fastq.gz |       | Artificial_Sputum |   3    |   1    |    reverse   |
  | MB_1   | SRX1607054_T1.fastq.gz |       | Middlebrook       |   1    |   1    |    reverse   |
  | AS_2   | SRX1607055_T1.fastq.gz |       | Middlebrook       |   2    |   1    |    reverse   |
  | AS_3   | SRX1607056_T1.fastq.gz |       | Middlebrook       |   3    |   1    |    reverse   |
